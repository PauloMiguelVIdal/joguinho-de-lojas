...
function Interface() {
    ...
    return (
        <div className="w-[100vw] bg-gradient-to-b from-[#6411D9] to-[#350973] h-[100vh]  flex justify-center items-center">
            <Events />
            <Notificação />
            <div className="w-[95vw] h-[90vh] rounded-[20px] bg-gradient-to-b from-[#6E0BF9] to-[#F27405] grid grid-rows-9 grid-cols-8 gap-[20px] p-[20px]">
                ...
                <div className="grid col-start-4 col-end-9 row-start-4 row-end-10">
                    <ButtonChange />
                </div>
                ...
                <div className="grid col-start-5 col-end-10 row-1">
                    <Informations />
                </div>
