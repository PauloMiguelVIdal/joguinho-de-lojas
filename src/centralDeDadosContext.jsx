...
const dadosIniciais = {
    ...
    industria: {
      ...
      edificios: [
        ...
        },
        {
          ...
          quantidade: 0,
          finanças: {
            faturamentoUnitário: 290000,
            impostoFixo: 14500000,
            impostoSobreFatu: 0.1,
            rent: 32,
          },
          lojasNecessarias: {
    ...
    imobiliario: {
      ...
      edificios: [
        ...
        {
          nome: "Tanque De Armazenamento De Fluidos",
          nomeEditável: "Tanque De Armazenamento De Fluidos",
