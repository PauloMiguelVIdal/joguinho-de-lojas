...
export default function Notificação() {
  ...
  const fimGame          = useCentralStore((s) => s.fimGame);
  ...
  const modalInicio        = useCentralStore((s) => s.modalInicio);
  const modalCompraTerrenos = useCentralStore((s) => s.modalCompraTerrenos);
  const modalContinuarDias = useCentralStore((s) => s.modalContinuarDias);
