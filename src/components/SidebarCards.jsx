...
const CardClassico = ({ cartao }) => (
  ...
  >
    ...
    <div
      ...
      style={{ backgroundColor: cartao.cor4, color: cartao.cor1, opacity: 0.9 }}
    >
      {cartao.banco}
    </div>
...
const CardModerno = ({ cartao }) => (
  ...
  >
    ...
    <div className="p-4 relative z-10">
      ...
      {/* Footer */}
      <div className="border-t pt-2" style={{ borderColor: cartao.cor4, opacity: 0.3 }}>
...
const WavePatternsCard = ({ cartao }) => (
  ...
  >
    ...
    <div className="p-4 relative z-10">
      ...
      <div
        className="absolute top-3 right-3 px-2 py-1 rounded-full text-[10px] font-black"
        style={{ backgroundColor: "rgba(255,255,255,0.9)", color: cartao.cor1 }}
      >
        {cartao.banco}
      </div>
...
>
                {economiaSetores?.contratosBancos?.length > 0 ? (
                    economiaSetores.contratosBancos.map((contrato, index) => (
                        <div className="mb-2 bg-white/5 backdrop-blur-sm rounded-3xl p-5 border border-white/10" key={index}>
                    ...
                    <div className="flex justify-between text-sm text-gray-300 mt-1">
                        <span>  Limite total: R$ {limite.toLocaleString('pt-BR')}</span>
