...
const GraficoProvider = ({ children }) => {
...
const [dados, setDados] = useState({
    grafico: {
        ...
        produtos: {
          ...
          return (
            <GraficoContext.Provider value={{ dados, atualizarDados, atualizarDadosProf, atualizarDadosProf2, atualizarDadosProf3, atualizarDadosVariados }}>
              {children}
        ...
        export { GraficoContext, GraficoProvider };