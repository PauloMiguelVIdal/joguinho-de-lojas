...
const AcougueNegocio = () => {
  ...
  // 🥩 Beef — alto valor e custo elevado (melhor margem)
  {
    id: 1,
  ...
  {
    id: 4,
    nome: "Corte Nobre Angus",
    tipo: "beef",
    quantidade: 1500,
    preco: 39000,
    precoKg: 26,
    qualidade: "Angus Especial",
    icon: "🥩",
  },

  // 🍗 Chicken — custo baixo, boa margem
  {
    id: 5,
    nome: "Granja Feliz",
    tipo: "chicken",
  ...
  // 🌭 Sausage — custo alto, margem menor
  {
    id: 13,
