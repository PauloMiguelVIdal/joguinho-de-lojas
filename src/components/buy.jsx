                ...
                <div className="flex h-[85%] items-center">
                    ...
                    <div className="flex justify-around w-full mb-4 h-full">
                        ...
                        <div className="flex flex-col w-[80%] mr-8 ml-4 justify-between h-full">
                            {/* Título "Terrenos" */}
                            <div className="bg-gradient-to-l from-[#6411D9] to-[#F27405] rounded-[5px] ">
                                <h1 className="text-white text-xl font-bold ml-[10px]">Terrenos</h1>
                            </div>
    
                            {/* Informações de preço */}
                            <div className="  rounded-[5px]  mt-2">
                                <div className="flex items-center">
                                    <div className="bg-[#6411D9] w-4 h-4 rounded-[5px] flex items-center justify-center">
                            ...
                            <div className="bg-[#350973] rounded-[20px] flex items-center justify-between  mt-2">
                                <div className="flex items-center">
