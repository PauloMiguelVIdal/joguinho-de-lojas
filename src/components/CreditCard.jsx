...
//                   <div 
//                     className="w-96 h-60 rounded-3xl p-8 text-white relative overflow-hidden cursor-pointer transform transition-all duration-300 hover:-translate-y-2 hover:rotate-x-1 shadow-xl"
//                     style={{
    ...
    <div className="w-full min-h-screen bg-gray-100 p-6 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {cards.map((card) => (
          <div
            key={card.id}
            className={`w-96 h-60 rounded-3xl p-8 relative overflow-hidden flex flex-col justify-between ${card.className}`}
            style={card.style || {}}
          >
            {/* Chip */}
            <div
...
//     <div 
//       className="w-[350px] h-[200px] rounded-3xl p-6 text-white relative overflow-hidden shadow-2xl transform hover:scale-105 transition-all duration-300"
//       style={{
...
//     <div 
//       className="w-[350px] h-[200px] rounded-3xl text-white relative overflow-hidden shadow-2xl transform hover:rotate-1 transition-all duration-300"
//       style={{
...
//     <div 
//       className="w-[350px] h-[200px] rounded-xl text-white relative overflow-hidden shadow-2xl"
//       style={{
...
//         </div>
//         <div className="text-right">
//           <div className="text-xs opacity-75 mb-1">val até</div>
//           <div className="text-sm font-medium">12/28</div>
//         </div>
//       </div>
//     </div>
...
//   const CardDesign2 = ({ design }) => (
//     <div 
//      className="w-[350px] h-[200px] rounded-3xl text-white relative overflow-hidden shadow-2xl transform hover:scale-110 transition-all duration-500"
//       style={{
//         background: `linear-gradient(45deg, ${design.cor1} 0%, ${design.cor2} 100%)`
//       }}
//     >
...
//           </div>
//           <div className="text-right">
//             <div className="text-xs opacity-90 mb-1">VAL ATÉ</div>
...
//     <div 
//       className="w-[350px] h-[200px] rounded-3xl text-white relative overflow-hidden shadow-2xl transform hover:scale-105 transition-all duration-500"
//       style={{
...
//     <div 
//       className="w-[350px] h-[200px] rounded-3xl text-white relative overflow-hidden shadow-2xl"
//       style={{
...
//       <div className="p-6 relative z-10">
//         <div 
//           className="absolute top-4 right-4 px-4 py-2 rounded-3xl text-xs font-black backdrop-blur-sm"
//           style={{ 
