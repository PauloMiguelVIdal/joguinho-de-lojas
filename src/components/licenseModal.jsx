...
export const LicenseModal = ({ setor,nomeLicença,index }) => {
    ...
    return (
        <div className="w-full pb-[30px]">
            <div style={{ backgroundColor: setorInfo.cor3 }} className="w-[100%] h-[300px] rounded-[20px] self-center justify-between shadow-xl">
                <div style={{ backgroundColor: setorInfo.cor2 }} className="w-full flex items-center h-[15%] rounded-t-[20px] self-center p-[5px]">
                    <div
                    ...
                    <div className="text-white text-[30px] ml-[20px] fonteBold">{nomeLicença}</div>
                </div >
