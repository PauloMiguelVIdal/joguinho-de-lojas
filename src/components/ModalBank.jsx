      ...
      {renderCard(cartao)}
                  ...
                  <div className="space-y-3 w-[350px]">
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-gray-800 bg-opacity-80 rounded-lg p-3 text-center">
                ...
                <div className="flex-1 w-full">
                  <div className="bg-gray-800 bg-opacity-90 backdrop-blur-sm rounded-2xl p-6 h-full w-full">
                    ...
                    <button
                      className={`w-full py-3 rounded-lg font-bold text-white transition-all duration-300 hover:scale-105 ${
                        cartao.tipo === 'Básico' ? 'bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800' :
                        cartao.tipo === 'Premium' ? 'bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800' :
