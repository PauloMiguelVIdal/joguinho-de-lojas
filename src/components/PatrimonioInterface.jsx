...
const patrimonio = economiaSetores.patrimonio
  ...
  const investmentData = [
    { id: 1, value: economiaSetores.agricultura.economiaSetor.patrimonio, bgColor: "bg-gradient-to-r from-green-500 to-green-600", icon: agricultura },
    { id: 2, value: economiaSetores.tecnologia.economiaSetor.patrimonio, bgColor: "bg-gradient-to-r from-orange-500 to-orange-600", icon: tecnologia },
    { id: 3, value: economiaSetores.industria.economiaSetor.patrimonio, bgColor: "bg-gradient-to-r from-gray-500 to-gray-600", icon: industria },
    { id: 4, value: economiaSetores.comercio.economiaSetor.patrimonio, bgColor: "bg-gradient-to-r from-red-500 to-red-600", icon: comercio },
    { id: 5, value: economiaSetores.imobiliario.economiaSetor.patrimonio, bgColor: "bg-gradient-to-r from-blue-500 to-blue-600", icon: imobiliario },
    { id: 6, value: economiaSetores.energia.economiaSetor.patrimonio, bgColor: "bg-gradient-to-r from-yellow-500 to-yellow-600", icon: energia },
  ];
