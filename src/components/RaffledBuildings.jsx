...
const getRandomItems = (array, n) => {
    ...
    const gerarCampanha = (campanhaNome) => {
        ...
        let obrigatoriosS = 0, obrigatoriosA = 0, obrigatoriosB = 0, obrigatoriosC = 0;
        ...
        const objetosSelecionados = nomesFinais.map(nome => {
        ...
        console.log(`🎯 Campanha: ${campanhaNome} | Edifícios selecionados:`, nomesFinais);
    };
    ...
    <div className="flex justify-center items-center z-50 bg-black bg-opacity-90 w-[100vw] h-[100vh] fixed top-0 left-0 select-none">
        ...
        >
            ...
            <div className="overflow-y-auto flex-1 px-8 py-6 space-y-6 flex flex-col items-center">
                {/* 🔹 Se nenhuma campanha foi selecionada, mostra as opções (limitado a 3) */}
                            ...
                            {campanhaSelecionada && (
                                ...
                                >
                                    {selectedItems.map((ed, i) => {
                                        // 🔹 Localiza o setor e índice do edifício usando a mesma lógica do Localizador
                                        ...
                                        // 🔹 Pega a quantidade real
                                        const quantidade = (setorEncontrado && indice !== -1) ? dados[setorEncontrado].edificios[indice].quantidade : 0;
...
`;
                                        return (
                                            <motion.div
                                                ...
                                                style={{
                                                    background: quantidade > 0 ? gradienteDourado : '#ffffff10',
                                                    backgroundBlendMode: quantidade > 0 ? 'overlay' : 'normal'
                                                }}
                                            >
                                                {Localizador(ed.nome)}
                                            </motion.div>
