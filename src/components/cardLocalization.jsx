...
export const CardLocalization = ({ index, setor, abrirModalSell }) => {
 ...
 <button
              ...
              `}
                                    ...
                                    style={{ backgroundColor: setorInfo.cor3 }} className=" w-[20%]  h-[80%] flex items-center justify-around rounded-[12px]">
                                    <img src={ConstuirImg} className="h-[60%] aspect-square " />
